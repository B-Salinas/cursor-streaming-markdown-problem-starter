...
function handleNewline() {
    if (currentState.inCodeBlock) {
        if (currentState.codeLanguage === '') {
            ...
            const codeElement = currentContainer.lastElementChild.lastElementChild;
...
function outputCurrentChar(char = currentState.buffer) {
    ...
    let element;
    if (currentState.inCodeBlock) {
        element = currentContainer.lastElementChild.lastElementChild;
    }
    else if (currentState.inInlineCode) {
        element = currentContainer.lastElementChild;
    }
    else {
        element = currentContainer.lastElementChild;
